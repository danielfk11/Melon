...
```bash
dotnet add package MelonMQ.Client --version v1.0.1
```
...
```xml
<ItemGroup>
  <PackageReference Include="MelonMQ.Client" Version="v1.0.1" />
  <PackageReference Include="MelonMQ.Protocol" Version="v1.0.1" />
</ItemGroup>
```
